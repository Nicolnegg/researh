# ----------------------------------------
# New BINSEC (>=0.11) uses SSE scripts via -sse -sse-script.
# Keep the templates minimal and focused on entrypoint + directives.
CoreBinsecConfig = """
starting from {}
"""
# ----------------------------------------
...
"""
# ----------------------------------------
# Legacy INI templates (BINSEC <= 0.10) kept for reference.
LegacyCoreBinsecConfig = """
[kernel]
isa = x86
entrypoint = {}
[x86]
...
directives = {}
"""
LegacyStandardBinsecConfig = LegacyCoreBinsecConfig + """
#robust = true
#robust-merge = yes
...
#optim-all = true
"""
LegacyRobustBinsecConfig = LegacyCoreBinsecConfig + """
robust = true
robust-merge = yes
robust-mode = validation
[fml]
