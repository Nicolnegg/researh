...
export PATH="PATH_TO_BINSEC_DIR:$PATH"   # directory containing the binsec binary/AppImage / tools-paper
cd ~/Documentos/M2-Cyber/RESEARCH/VM/tools-paper/Examples/example-ineq/example.dir
pyabduce \
